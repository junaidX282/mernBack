...
const Navbar = () => {
  const { setShowLogin, user, logout, isOwner, axios, setIsOwner,toast } =
    useAppContext();
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Search Box visible only large Screen */}
        <div
        ...
        <div className="flex max-sm:flex-col items-start sm:items-center gap-6">
          ...
          <button
            ...
            hober:bg-primary-dull transition-all text-white rounded-lg"
          >
            {user ? 'Logout' : 'Login'}
          </button>
        </div>
