...
const CarDetails = () => {
  ...
  const {id} = useParams()
  const {cars, axios, pickupDate, setPickupDate, returnDate, setReturnDate, navigate} 
  = useAppContext()
  ...
  const handleSubmit = async(e) => {
    e.preventDefault()
    console.log("Booking car with ID:", id, "Pickup Date:", pickupDate, "Return Date:", returnDate);
